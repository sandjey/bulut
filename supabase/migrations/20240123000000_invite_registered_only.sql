-- ============================================================
--  Приглашать в комнату можно ТОЛЬКО зарегистрированных пользователей Bulut.
--  Если такого профиля нет — понятная ошибка (пусть сначала зарегистрируется).
...
begin
  ...
  -- Пользователь должен быть зарегистрирован в Bulut.
