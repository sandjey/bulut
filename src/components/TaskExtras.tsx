...
import { CheckSquare, Square, Plus, Trash2, Paperclip, LinkIcon, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <div>
        <span className="label flex items-center gap-1.5">
          <Paperclip className="h-3.5 w-3.5" /> Вложения / ссылки
        </span>
          ...
          {attachments.map((a) => (
            ...
            >
              ...
              <a
                ...
                className="flex min-w-0 flex-1 items-center gap-1 truncate text-sm text-brand hover:underline"
              >
